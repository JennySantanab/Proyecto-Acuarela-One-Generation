...
public class AcuarelaSistema extends JFrame{
    ...
    public AcuarelaSistema(String rol, String nombre, String apellido, String username, String dni, String telefono, String email) {

        setContentPane(mainPanel);
        setTitle("Detalles Acuarela");
        ...
        actualizar_ajustes_BTN.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (!"".equals(ruc_ajustes_TF.getText()) || !"".equals(nom_ajustes_TF.getText()) || !"".equals(telf_ajustes_TF.getText()) || !"".equals(direc_ajustes_TF.getText())) {
                    ajustes.setRuc_acuarela(ruc_ajustes_TF.getText());
                    ajustes.setNom_acuarela(nom_ajustes_TF.getText());
                    ajustes.setTelf_acuarela(telf_ajustes_TF.getText());
                    ajustes.setDirec_acuarela(direc_ajustes_TF.getText());
                    ajustes.setMensaje_acuarela(mensaje_ajustes_TF.getText());
    ...
    public void verTablaAjustes () {
        ...
        ruc_ajustes_TF.setText("" + ajustes.getRuc_acuarela());
        nom_ajustes_TF.setText("" + ajustes.getNom_acuarela());
        telf_ajustes_TF.setText("" + ajustes.getTelf_acuarela());
        direc_ajustes_TF.setText("" + ajustes.getDirec_acuarela());
        mensaje_ajustes_TF.setText("" + ajustes.getMensaje_acuarela());
    }

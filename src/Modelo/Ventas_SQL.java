    ...
    public void pdfV(int idventa, String Cliente, double total, String usuario) {
        try {
            ...
            try {
                ...
                rs = pst.executeQuery();
                if (rs.next()) {
                    mensaje = rs.getString("mensaje_acuarela");
                    Encabezado.addCell("Ruc:    " + rs.getString("ruc_acuarela") + "\nNombre: " + rs.getString("nom_acuarela") + "\nTeléfono: " + rs.getString("telf_acuarela") + "\nDirección: " + rs.getString("direc_acuarela") + "\n\n");
                }
            } catch (Exception e) {
                System.out.println(e.toString());
            }
